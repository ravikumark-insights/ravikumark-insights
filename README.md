![Header](https://capsule-render.vercel.app/api?type=venom&color=0:0a0f1e,40:0d1b2a,100:00b4d8&height=220&section=header&text=Ravi%20Kumar&fontSize=65&fontColor=ffffff&fontAlignY=40&desc=Business%20Analyst%20%7C%20Data%20Engineer%20%7C%20AWS%20Cloud&descAlignY=62&descColor=00e5ff&animation=twinkling)
...
![ETL Pipelines](https://img.shields.io/badge/ETL%20Pipelines-00BCD4?style=for-the-badge&logo=apacheairflow&logoColor=white)
...
```text
📦 End-to-end AWS Data Engineering pipelines (S3 → Glue → Redshift)
📊 Advanced SQL analytics & KPI dashboards
⚙️  Apache Airflow orchestrated ETL workflows
🗂  A clean, production-ready portfolio for BA & DE roles
```
...
![Footer](https://capsule-render.vercel.app/api?type=venom&color=0:00b4d8,60:0d1b2a,100:0a0f1e&height=120&section=footer)
